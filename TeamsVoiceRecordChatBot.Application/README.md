# TeamsVoiceRecordChatBot.Application
...
- In a terminal, navigate to `TeamsVoiceRecordChatBot.Application`

    ```bash
    # change into project folder
    cd TeamsVoiceRecordChatBot.Application
    ```
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `TeamsVoiceRecordChatBot.Application` folder
  - Select `TeamsVoiceRecordChatBot.Application.csproj` file
